  ...
  <WobbleCard containerClassName="col-span-1 lg:col-span-3 bg-blue-900 min-h-[500px] lg:min-h-[600px] xl:min-h-[300px] ml-10">
    ...
    />
      ...
      <TextHoverEffect text="BIGYIKES"/>
        ...
        <div className=" py-4 dark:bg-black bg-gray-100 w-full">
      <div className="max-w-7xl mx-auto text-center">
        <p className="font-bold text-xl md:text-4xl dark:text-white text-pink-500">
          Serving{" "}
        ...
        <p className="text-sm md:text-lg text-neutral-500 max-w-2xl mx-auto py-4">
          Break free from traditional boundaries. Create content from anywhere. Perfect for Nerds and
          Betas.
        </p>
      </div>
      <WorldMap
