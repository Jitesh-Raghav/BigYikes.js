...
const SelectTemplate = () => {
  ...
  const handleNext = () => {
    ...
    localStorage.setItem("selectedTemplate", selectedVideo);
    navigate("/story");
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-600 flex flex-col items-center p-6 font-Sanso">
      ...
      <div className="flex items-center justify-around w-full">
        ...
        <div className="w-1/3 h-[485px] mr-36 ml-5 flex-col gap-3 space-y-16">
          <div className="w-full h-[80%] max-w-4xl mx-auto min-h-96 border border-dashed bg-white dark:bg-black border-neutral-200 dark:border-neutral-800 rounded-lg">
            <FileUpload onChange={handleFileUpload} />
          </div>
          <button
            onClick={handleNext}
            disabled={!selectedVideo}
            className={`px-5 py-3 rounded-xl font-Sanso text-gray-50 text-sm ml-[85%] ${selectedVideo ? 'bg-pink-400 hover:bg-pink-500 text-white cursor-pointer' : 'bg-gray-500 cursor-not-allowed'}`}
          >
            Next
          </button>
        </div>
...
//       <FileUpload onChange={handleFileUpload} />
//     </div>
//     <button className='bg-pink-400 px-5 py-3 rounded-xl font-Sanso text-gray-100 text-sm ml-[85%] hover:bg-pink-500 cursor-not-allowed'>Next</button>
//       </div>
//       </div>
//       {/* Categories */}
//       <div className="w-[60%] flex justify-between items-start gap-4">
