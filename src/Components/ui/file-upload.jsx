...
export const FileUpload = ({
  ...
  return (
    (<div className="w-full font-Sanso" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p
            className="relative z-20 font-sans font-normal text-neutral-600 dark:text-neutral-400 text-base mt-2">
          ...
          <div className="relative w-full mt-10 max-w-xl mx-auto">
            ...
            {!files.length && (
              <motion.div
                ...
                className="absolute opacity-0 border border-dashed border-pink-400 inset-0 z-30 bg-transparent flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md"></motion.div>
            )}
          </div>
        </div>
      </motion.div>
...
export function GridPattern() {
  ...
  return (
    (<div
      className="flex bg-gray-200 dark:bg-neutral-900 flex-shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px  scale-105">
